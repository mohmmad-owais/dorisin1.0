        ...
        >
                ...
                <div className="row">
                  <div className="col-lg-8 offset-lg-2 text-white text-center">
                    ...
                    <p className="padding-t-15 home-desc">
                      Etiam sed.Interdum consequat proin vestibulum
                      className at.
                    </p>
          ...
          <div class="wave-effect wave-anim">
            <div class="waves-shape shape-one">
              <div
                class="wave wave-one"
                style={{ backgroundImage: "url(assets/imgs/wave1.png)" }}
              />
            </div>
            <div class="waves-shape shape-two">
              <div
                class="wave wave-two"
                style={{ backgroundImage: "url(assets/imgs/wave2.png)" }}
              />
            </div>
            <div class="waves-shape shape-three">
              <div
                class="wave wave-three"
                style={{ backgroundImage: "url(assets/imgs/wave3.png)" }}
              />
            </div>
          </div>
        </section>
